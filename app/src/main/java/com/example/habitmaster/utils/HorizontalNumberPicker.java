...
public class HorizontalNumberPicker extends LinearLayout {
    ...
    public HorizontalNumberPicker(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                min = a.getInt(R.styleable.HorizontalNumberPicker_min, 0);
                max = a.getInt(R.styleable.HorizontalNumberPicker_max, 10);
                int value = a.getInt(R.styleable.HorizontalNumberPicker_value, min);
                setValue(value);
            } finally {
                a.recycle();
            }
